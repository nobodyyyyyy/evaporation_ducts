SUBROUTINE SINFFT ( N, X )
    ...
    !                                                radix-8 iterations
              ...
              DO 130 J = 1, N8
                 ...
                 J7 = J6 + INTT
    !***
                 CALL R8SYN (INTT, NT, COSTBL, SINTBL, B(1), B(J1), B(J2),B(J3), B(J4), B(J5), B(J6), B(J7)  )
    !***
                 NT = NT / 8
                 INTT = 8 * INTT
      130     CONTINUE
    ...
    !
    !
           SUBROUTINE R8SYN ( INTT, NT, COSTBL, SINTBL, B0, B1, B2, B3,B4, B5, B6, B7 )
    !
    !***********************************************************************
    !
    ...
    !
           DATA  R2    / 1.41421356237310D+0 /CPI4  / 0.70710678118655D+0 /,  CPI8  / 0.92387953251129D+0 /,  SPI8  / 0.38268343236509D+0 /
    !
    !
    !----------------------------------------------------------------------+
    !
