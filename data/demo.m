function M1_mode=demo(T,TS,rh,U,p)  
P = p;%ѹǿ
t=T;%�����¶�
RH=rh;%���ʪ��
u=U;%����
...
%      rhoa = 1.12; %dry�����ܶ�
     ...
     du = u-us;
     dt = ts-t-0.0098*zt; %?�ĳ�λ��
     dq = Qs-Q; 
     ta = t+tdk;
     
     Rib = -grav*zu/ta*(dt+0.61*ta*dq)/u^2; %ͨ��Rib�ж��ȶ���
...
zL0M = log(zzz0m);
zL0H = zL0M + zkbm;
zzzs = zzz0m*0.06;   %ΪʲôҪ��0.06��
zfacM = log(1.+clam/cmum/zzzs)*exp(-cmum*zzzs)/clam;   %exp����д���˰ɣ�
...
if zs<0
    ...
    elseif (Rib<0) %for unstable conditions
        coefficients3=[-116.93 0 0 0 126.9 0 0 0 0 -115.09 111.64 -3.572 3.8304 -4.5297 25.776 0.45351 -26.473 6.6361 -3.3234 0 0 -0.65868 1.0393;%���ϵ�������ϵ���ô��һ����
